...
const createRealmApolloClient = (app) => {
  ...
  const link = new HttpLink({
    ...
    uri: `https://us-east-1.aws.stitch.mongodb.com/api/client/v2.0/app/${app.id}/graphql`,
    ...
    fetch: async (uri, options) => {
      ...
      // options.headers.apiKey = `3D8Rw5OLWEO9i3aTZKhghibpzxqBzFPtCknIg8q6SlGiIlI8uYruoyAaYOee7DXt`;
